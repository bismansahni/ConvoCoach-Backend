...
#         ) / 4))
#
#         # Log or save the results instead of returning a Flask response
#         print(f"Transcription: {transcription}")
#         print(f"Confidence Score: {confidence_score:.2f}")
#         print(f"Words Per Minute: {words_per_minute:.2f}")
#         print(f"Filler Words Count: {filler_count}")
#         print(f"Audio Features: Avg Pitch: {avg_pitch}, Avg Loudness: {avg_loudness}")
#
#         save_proper_analysis_to_database(interview_id, transcription, confidence_score, words_per_minute, filler_count, avg_pitch, avg_loudness, sentiment)
#
#     except Exception as e:
...
#                 cred = credentials.Certificate("service-key.json")  # Path to your Firebase service account key
